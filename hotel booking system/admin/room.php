  ...
  if($extension == 'jpg'||$extension == 'png'||$extension == 'gif' )
	...
	else
	{
		if(move_uploaded_file($temp, $store))
		{
				...
				if(!$price==''||!$text=''||!$address==''||!$type==''||!$_FILES['image']=='')
				{
				$sql = "INSERT INTO booking1 (rimage,rtype,rprice,rtext,raddress) VALUES('$fnew','$type ','$price','$text','$address')";  // store the submited data ino the database :images
				mysqli_query($db, $sql); 
          ...
          <form action=" " method="post"  enctype="multipart/form-data">
            ...
            <div class="form">
              ...
              <p class="inline-field">
                ...
                <select class="field size3" name='address'>
                  <option disabled >Room Address</option>
...
<!-- Footer -->
<div id="footer">
  <div class="shell"> <span class="left">&copy; 2022</span> <span class="right"> Design by <a href="#">Manoj & Bhumi</a> </span> </div>
</div>
<!-- End Footer -->
</body>
</html>
